...
export const CustomerRankMasterEditDialog = () => {
  ...
  return (
    <EditPC mode="dialog">
      <div className="edit_pc_body_inner edit_master cusomer_rank_master">
        <div>
          <div className="item_wrap">
            <div className="item_box">
              <div className="item_head">顧客ランク（工事金額）名<Required /></div>
              <Input
                className=""
                value=""
                onChange={() => {}}
          ...
          <div className="item_wrap">
            <div className="item_box">
              <div className="item_head">工事金額<Required /></div>
              <Input
                className=""
                value=""
                onChange={() => {}}
