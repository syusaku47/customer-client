...
export type SeikyuUtiwake2Param = {
  largeList: {
    // No.
    largeNumber: string,
    // 工事名称 大項目
 ...
 * 請求書/内訳明細2
 */
export class SeikyuUtiwake2PdfModule extends PdfModule<SeikyuUtiwake2Param> {
  constructor() {
    super(
      [
        template,
  ...
  createSvg(param: SeikyuUtiwake2Param, templateSvgStrList: string[]): string[] {
    // - 定数 -
    const height = 22;
    const maxLength = 18;
