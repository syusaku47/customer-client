...
export type MitsumoriUtiwake1Param = {
  largeList: {
    // No.
    largeNumber: string,
    // 工事名称 大項目
 ...
 * 見積書/内訳明細1
 */
export class MitsumoriUtiwake1PdfModule extends PdfModule<MitsumoriUtiwake1Param> {
  constructor() {
    super(
      [
        template,
  ...
  createSvg(param: MitsumoriUtiwake1Param, templateSvgStrList: string[]): string[] {
    // - 定数 -
    const height = 22;
    const maxLength = 18;
